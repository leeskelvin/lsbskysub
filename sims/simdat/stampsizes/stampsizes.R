...
v4dat1 = read.table("v4/b/calexp-HSC-R-8283-38.cat-input-n1.dat")
v4dat2 = read.table("v4/b/calexp-HSC-R-8283-38.cat-input-n4.dat")
v4dat3 = read.table("v4/b/calexp-HSC-R-9592-20.cat-input-n1.dat")
v4dat4 = read.table("v4/b/calexp-HSC-R-9592-20.cat-input-n4.dat")
v4dat = rbind(v4dat1,v4dat2,v4dat3,v4dat4)
colnames(v3dat) = colnames(v4dat) = c("x","y","flux","half_light_radius","q","theta","n","stamp_size")
v3dat[,"stamp_size"] = v3dat[,"stamp_size"]-10 # to correct for 10-pixel padding in the v3 dataset
col = rep(2,nrow(v3dat))
col[v3dat[,"n"]==4] = 3
xlim = ylim = range(c(v3dat[,"stamp_size"],v4dat[,"stamp_size"]))

# dev
pdf(file="stampsizes.pdf", width=5, height=5)
...
# plot
aplot(v3dat[,"stamp_size"], v4dat[,"stamp_size"], pch=".", xlab="v3 stamp size / pixels", ylab="v4 stamp size / pixels\n", mgp=c(1.5,0.25,0), las=1, xformat="p", yformat="p", xlim=xlim, ylim=ylim, col=col2rgba(col,0.01), cex=2, log="xy")

par("xpd"=TRUE)
scales = seq(0.1,1.2,by=0.1)
