...
for(i in 1:length(files)){
    ...
    genopt = "-FILTER_NAME kernel.conv -BACK_SIZE 128 -BACK_FILTERSIZE 5 -DETECT_THRESH 0.5 -ANALYSIS_THRESH 0.5 -DEBLEND_MINCONT 0.00005"
    
    # source extract
    output = system(paste0(sex, " -c ../sex_default/default.sex -CATALOG_NAME temp_cat.dat -CATALOG_TYPE ASCII -CHECKIMAGE_TYPE SEGMENTATION,BACKGROUND,BACKGROUND_RMS -CHECKIMAGE_NAME temp_seg.fits,temp_sky.fits,temp_std.fits ", genopt, " temp.fits 2>&1"), intern=T)
