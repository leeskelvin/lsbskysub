...
model0zipped = paste0("../../source_extraction/sex_modelled/model/denlo4a.model0.fits.fz")
model1zipped = paste0("../../source_extraction/sex_modelled/model/denlo4a.model1.fits.fz")
modelmapzipped = paste0("../../source_extraction/sex_modelled/map/denlo4a.map.fits.gz")
